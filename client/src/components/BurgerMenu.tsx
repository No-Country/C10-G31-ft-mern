  ...
  return (
    <div className='fixed top-0 left-0 z-10 w-full' >
        <div className='flex min-h-screen'>
            <div className='min-w-[240px] bg-gray-500 pt-36 min-h-screen h-full overflow-y-auto max-h-screen scrollbar-thin scrollbar-thumb-blue-300 scrollbar-track-gray-400'>
