      ...
      >
        ...
        <div className="flex">
            <input 
                type="submit" 
                value='Continuar' 
                className="bg-gray-600 px-3 py-5 rounded-md mt-7 w-full text-white font-bold text-xl md:inline-block md:w-auto md:px-12 md:w-full md:text-2xl cursor-pointer"
            />
        </div>
      </form>
    </div>
